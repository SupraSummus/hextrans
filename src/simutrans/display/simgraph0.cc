...
static void            simgraph0_convert_to_bitmask         (const image_t *image_in, uint8 alpha_flags);
...
static void            simgraph0_draw_signal_direction      (scr_coord_val, scr_coord_val, uint8, uint8, PIXVAL, PIXVAL, uint8);
...
static void simgraph0_convert_to_bitmask(const image_t *, uint8)
{
}
