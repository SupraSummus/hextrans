 ...
 * (see LICENSE.txt)
 *
 * Game-side network transfer paths (gameinfo fetch, save-game send/
 * receive, libcurl-backed HTTP).  The connection setup + raw byte
 * transfer paths shared with nettool stay in network_file_transfer.cc.
 */
