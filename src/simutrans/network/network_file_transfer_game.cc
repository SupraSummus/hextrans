 ...
 * (see LICENSE.txt)
 *
 * Game-side file-transfer and gameinfo helpers, linked into simutrans
 * only.  Split out from network_file_transfer.cc when the NETTOOL
 * preprocessor gate was retired in favour of per-binary source lists.
 */
