...
SOURCES += src/simutrans/descriptor/way_image_keys.cc
...
SOURCES += src/simutrans/network/network_easy_server.cc
SOURCES += src/simutrans/network/network_file_transfer.cc
SOURCES += src/simutrans/network/network_file_transfer_game.cc
...
SOURCES += src/simutrans/obj/way/way_image_slot.cc
